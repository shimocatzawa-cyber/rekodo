...
export type Database = {
  public: {
    Tables: {
      profiles: {
        Row: { id: string; username: string; display_name: string | null; /** @deprecated use city + country */ location: string | null; bio: string | null; created_at: string; taste_summary: string | null; taste_summary_count: number | null; taste_summary_history: Json; last_synced_at: string | null; avatar_url: string | null; is_donor: boolean | null; is_public: boolean; city: string | null; country: string | null; country_code: string | null; star_sign: string | null; bandcamp_username: string | null; subscription_tier: string | null; role: string | null };
        Insert: { id: string; username: string; display_name?: string | null; location?: string | null; bio?: string | null; created_at?: string; taste_summary?: string | null; taste_summary_count?: number | null; taste_summary_history?: Json; last_synced_at?: string | null; avatar_url?: string | null; is_donor?: boolean | null; is_public?: boolean; city?: string | null; country?: string | null; country_code?: string | null; star_sign?: string | null; bandcamp_username?: string | null; subscription_tier?: string | null; role?: string | null };
        Update: { username?: string; display_name?: string | null; location?: string | null; bio?: string | null; taste_summary?: string | null; taste_summary_count?: number | null; taste_summary_history?: Json; last_synced_at?: string | null; avatar_url?: string | null; is_donor?: boolean | null; is_public?: boolean; city?: string | null; country?: string | null; country_code?: string | null; star_sign?: string | null; bandcamp_username?: string | null; subscription_tier?: string | null; role?: string | null };
        Relationships: [];
      };
      digital_imports: {
