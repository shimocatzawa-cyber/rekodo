    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
          ...
          <tr>
            <td style="padding-bottom:24px;">
              <p style="margin:0 0 4px;font-family:'Courier New',monospace;font-size:11px;letter-spacing:0.08em;text-transform:uppercase;color:#CC5500;">
                01 — collection
              </p>
              <p style="margin:0;font-family:'Courier New',monospace;font-size:13px;line-height:1.8;color:rgba(255,255,255,0.6);">
                Add your first record to start building your vinyl collection.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding-bottom:24px;">
              ...
              <p style="margin:0;font-family:'Courier New',monospace;font-size:13px;line-height:1.8;color:rgba(255,255,255,0.6);">
                Take the taste quiz so we can find your listening archetype.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding-bottom:48px;">
              ...
              <p style="margin:0;font-family:'Courier New',monospace;font-size:13px;line-height:1.8;color:rgba(255,255,255,0.6);">
                Get AI-powered record recommendations based on your collection and taste.
              </p>
            </td>
          </tr>
          <tr>
