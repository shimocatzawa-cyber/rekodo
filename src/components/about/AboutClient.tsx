...
const FAQ_SECTIONS: { section: string; items: { q: string; a: React.ReactNode }[] }[] = [
  ...
  },
  {
    ...
    items: [
      {
        q: "What is Community?",
        a: "Community is where you find other collectors on rekōdo. Top Matches surfaces collectors with the closest taste based on shared artists, genre, and decade — each match card shows Collection Similarity (shared artists, IDF-weighted), Style Similarity (genre and decade cosine), and Star Sign Compatibility (traditional zodiac aspects, only when both collectors have set a star sign); Popular shows albums appearing across the most collections right now; Collectors I Follow tracks activity from people you follow; Open to Offers lists records other collectors are willing to sell; and All Collectors lets you browse everyone on the platform.",
      },
      {
