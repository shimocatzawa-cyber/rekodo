    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "5px" }}>
        ...
        <button
          ...
          style={{ fontFamily: MONO, fontSize: "10px", letterSpacing: "0.05em", color: hovered ? "#a34400" : ORANGE, background: "none", border: "none", cursor: "pointer", padding: 0, flexShrink: 0, transition: "color 0.15s", whiteSpace: "nowrap" }}
        >
          Find It ↗
        </button>
